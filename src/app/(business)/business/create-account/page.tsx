      ...
      <section className={styles.section}>
        <div  className={styles.hero}>
          <div className={`${styles.content} animate__animated animate__backInLeft`}>
            <h1 className={styles.heading}>Download The Cashmatrix Business App and Open an Account Today!!!</h1>
            <p className={styles.description}>
              Click on the Google Play button to download for android or on the App Store button to
              download for ios, follow the on screen prompt to open an account, fund your account and see your business grow.
            </p>
          ...
          <div className={`${styles.imageBox} animate__animated animate__backInRight`}>
            <Image src={businessImage} alt="Hero Image" className={styles.image} priority={true}/>
          </div>
        </div>
      </section>
    </main>
